...
## 1. Radar dos 7 eixos transversais
...
- Valores = média (1–5) de cada eixo, conforme `radar-axes.md`.
- A curva `alvo` é opcional, mas recomendada: mostra o salto pretendido no horizonte médio (respeitando "1 nível por trimestre").
- **Fallback (Mermaid < 11.6):** use a tabela de eixos do `radar-axes.md` com barras textuais `█/░`.
